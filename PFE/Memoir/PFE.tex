...
En génie logiciel, un diagramme de classes dans le langage de modélisation unifié (UML) est un type de diagramme de structure statique qui décrit la structure d'un système en montrant les classes du système, leurs attributs, opérations (ou méthodes) et les relations entre les objets.\textsuperscript{[11]}

\subsubsection{Diagramme de classe général}

\begin{figure}[h]
\centering
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 7.3in]{../Conception/Class/PNG/Utilisateur.png}}}
...
\begin{figure}[h]
\centering
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 4.5in]{../Conception/Class/PNG/Administrateur.png}}}
...
\begin{center}
    ...
    \vspace{0.5in}
\end{center}
\addcontentsline{toc}{part}{\vspace{-0.12in}\color{Blue}{Webographie}}
\renewcommand{\ULdepth}{1.8pt}
