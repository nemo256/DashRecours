...
\fancypagestyle{myfancy}{%   
   ...
   \fancyhead{}
   \fancyfoot{}
   \fancyfoot[C]{\vspace{-0.35in}\textcolor{Gray}{\Large{Page}}\hspace{0.04in} \large{\thepage}\hspace{0.07in}\large{|}\hspace{0.07in}\large{76}}%\pageref{LastPage}}}
}%
\pagestyle{empty}
...
\begin{figure}[h]
\centering
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 3.1in]{../Conception/Usecase/PNG/General/Utilisateur1.png}}}
...
\centering
  \vspace{-0.1in}
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 4.5in]{../Conception/Usecase/PNG/Administrateur.png}}}
...
\begin{figure}[h]
\centering
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 3.0in]{../Conception/Usecase/PNG/Etudiant.png}}}
...
\rowcolor[HTML]{ECF4FF}
\textbf{Post condition}            & \begin{tabular}[c]{@{}l@{}}- Nous devons nous assurer qu'une copie de ce que l'étudiant a\\ entré est enregistrée en temps réel afin de ne pas perdre\\ d'informations (dans la machine de l'utilisateur en tant que fichier\\ temporaire et dans notre serveur si la connexion est bien établie).\\ - Assurer la livraison du recours aux enseignant.\\ - Nous voulons nous assurer que l'étudiant est informé de la\\ livraison du recours.\end{tabular} \\ \hline
\end{tabular}
...
\rowcolor[HTML]{DAE8FC}
\textbf{Séquencement nominal}      & \begin{tabular}[c]{@{}l@{}}1. Choisissez l'option d'inscription dans l'écran de ‘Login’.\\ 2. Remplir les informations (nom, prénom, matricule,...).\\ 3. Validez l'émail par le code reçu dans la boite émail.\end{tabular} \\ \hline
\rowcolor[HTML]{ECF4FF}
\textbf{Séquencement alternatif}   & \begin{tabular}[c]{@{}l@{}}A1. Validation du formulaire s'il y a des champs vides ou un\\ émail invalide (doit être au format émail '@ x.z') ou les mots\\ de passe ne correspondent pas.\end{tabular}                       \\ \hline
\rowcolor[HTML]{DAE8FC}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/login.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/register.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/registerFULL.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/registerFULL2.png}}
\caption{Page d'inscription}
\end{figure}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/index.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../Site/profileETAdd.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileETUpdate.png}}
\caption{Modifier Un Recours}
\end{figure}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileETRead.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 5in]{../Site/settings.png}}
\caption{Paramètres}
\end{figure}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/profileENSList.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileENSRefused.png}}
\caption{Recours Refusés}
\end{figure}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileENSRead.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/profileADMList.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileADMList2.png}}
\caption{Liste des utilisateurs (Recherche)}
\end{figure}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileADMAdd.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileADMUpdate.png}}
\caption{Modifier Un Utilisateur}
\end{figure}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/profileADMRead.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/trafic.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/dashboard.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/dashboard2.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/charts.png}}
\caption{Page des graphiques}
\end{figure}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.3in]{../Site/charts2.png}}
...
\begin{figure}[h]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.8in]{../Site/contact.png}}
